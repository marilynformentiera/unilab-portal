                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo '<tr>
                                    ...
                                    <td>' . $username . '</td>
                                    <td>
                                        <p>Pharma Name : <b>' . $firstName . '</b></p>
                                        <p>Branch Name : <b>' . $lastName . '</b></p>
                                    </td>
                                    <td>' . $email . '</td>
                                    <td>' . $phone . '</td>
                                    <td>' . $userType . '</td>
                                    <td class="text-center">
                                        <div class="row d-flex justify-content-center" >
                                            <button class="btn btn-sm btn-primary" style="width:100px" data-bs-toggle="modal" data-bs-target="#editUser' . $Id . '" type="button"  >Edit</button>';
                            if ($Id == 1) {
                            } else {
                                echo '<form action="partials/_userManage.php" method="POST">
                                                        </br>
                                                        <button name="removeUser" class="btn btn-sm btn-danger" style="width:100px" ;>Delete</button>
            ...
            <div class="modal-body">
                <form action="partials/_userManage.php" method="post">
                    <div class="form-group">
                        ...
                        <input class="form-control" id="username" name="username" placeholder="Set Username" type="text" required minlength="3" maxlength="11">
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <b><label for="firstName">Pharma Name:</label></b>
                            <input type="text" class="form-control" id="firstName" name="firstName" placeholder="Pharma Name" required>
                        </div>
                        <div class="form-group col-md-6">
                            <b><label for="lastName">Branch Name:</label></b>
                            <input type="text" class="form-control" id="lastName" name="lastName" placeholder="Branch Name" required>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group row my-0">
                        <div class="form-group col-md-6 my-0">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="tel" class="form-control" id="phone" name="phone" placeholder="9XXXXXXXXX" required pattern="[9][0-9]{9}" maxlength="10">
                            </div>
                        </div>
                        <div class="form-group col-md-6 my-0">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="cpassword" name="cpassword" placeholder="Renter Password" type="password" required data-bs-toggle="password" minlength="4" maxlength="21">
                    </div>
