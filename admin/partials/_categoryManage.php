...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['createCategory'])) {
        ...
        $sql = "INSERT INTO `division` (`divisionName`, `divisionDesc`, `divisionCreateDate`) VALUES ('$name', '$desc', current_timestamp())";
    ...
    if (isset($_POST['removeCategory'])) {
        ...
        $sql = "DELETE FROM `division` WHERE `divisionId`='$catId'";
        $result = mysqli_query($conn, $sql);
        if ($result) {
    ...
    if (isset($_POST['updateCategory'])) {
        ...
        $sql = "UPDATE `division` SET `divisionName`='$catName', `divisionDesc`='$catDesc' WHERE `divisionId`='$catId'";
        $result = mysqli_query($conn, $sql);
        if ($result) {
