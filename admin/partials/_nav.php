    <header class="header" id="header">
      ...
      <div class="header__img">
        <img src="assetsForSideBar/img/user.png" alt="">
      </div>
    </header>
      ...
      <nav class="nav">
        <div>
          <a href="index.php" class="nav__logo">
            ...
            <span class="nav__logo-name">Unilab Portal</span>
          </a>
